...
CREATE Table cultures (
    ...
    short_description TEXT,
	image_url VARCHAR(500),
	culture_type_id BIGINT NOT NULL REFERENCES culture_types(id) ON DELETE RESTRICT,
	parent_culture_id BIGINT REFERENCES cultures(id) ON DELETE RESTRICT
)
...
-- table place_relations à mettre potentiellement à jour car relations qui va dans tout les sens
-- CREATE TABLE place_relations (
-- id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  --  child_id BIGINT REFERENCES places(id) ON DELETE CASCADE,
    --parent_id BIGINT REFERENCES places(id) ON DELETE CASCADE,
    --relation_type VARCHAR(50), -- 'contient', 'borde', 'traverse', 'appartient'
